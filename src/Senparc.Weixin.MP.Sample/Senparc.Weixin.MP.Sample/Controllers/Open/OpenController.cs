...
namespace Senparc.Weixin.MP.Sample.Controllers
{
    ...
    public class OpenController : Controller
    {
        ...
        public ActionResult OAuth()
        {
            ...
            var callbackUrl = "http://zs.sasu.edu.cn/OpenOAuth/OpenOAuthCallback";//成功回调地址
        ...
        {
            //此处的URL格式类型为：http://zs.sasu.edu.cn/Open/Callback/$APPID$， 在RouteConfig中进行了配置，你也可以用自己的格式，只要和开放平台设置的一致。
