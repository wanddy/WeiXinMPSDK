...
namespace Senparc.Weixin.MP.Sample.Controllers
{
    ...
    public class FilterTestController : Controller
    {
        ...
        {
            return Content("访问正常。当前地址：" + Request.Url.PathAndQuery + "<br />请点击右上角转发按钮，使用【在浏览器中打开】功能进行测试！<br />或者也可以直接在外部浏览器打开 http://zs.sasu.edu.cn/FilterTest/ 进行测试。");
        }
        ...
        {
            return Content("访问正常。当前地址：" + Request.Url.PathAndQuery + "<br />请点击右上角转发按钮，使用【在浏览器中打开】功能进行测试！<br />或者也可以直接在外部浏览器打开 http://zs.sasu.edu.cn/FilterTest/Redirect 进行测试。");
        }
